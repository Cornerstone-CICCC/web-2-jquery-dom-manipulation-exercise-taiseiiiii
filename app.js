...
$(function () {
  ...
  $("#exercise2Button").on("click", function () {
    $("#exercise2 p").parent().css({ backgroundColor: "red" });
  });
  ...
  $("#exercise3Button").on("click", function () {
    $("#exercise3 p").parents("div").css({ backgroundColor: "yellow" });
  });
  ...
  $("#exercise4Button").on("click", function () {
    $(this).siblings("h3").next().next("p").hide();
  });
  ...
  $("#exercise5Button").on("click", function () {
    $(this).siblings("div").children("p").css({ border: "2px solid green" });
  });
